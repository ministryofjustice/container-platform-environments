...
locals {
  ...
  namespace_team_access_assignments_cd_nonlive = {
    for key, assignment in local.namespace_team_access_assignments :
    key => assignment
    if assignment.cluster == "container-platform-cd-nonlive"
  }

  namespace_team_access_assignments_cd_live = {
    for key, assignment in local.namespace_team_access_assignments :
    key => assignment
    if assignment.cluster == "container-platform-cd-live"
  }
