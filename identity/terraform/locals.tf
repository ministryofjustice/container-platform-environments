...
<<<<<<< HEAD
  ...
  # Clusters grouped by live/nonlive suffix for provider-specific routing.
  octo_nonlive_clusters = toset([for cluster in local.namespace_clusters : cluster if endswith(cluster, "-octo-nonlive")])
  octo_live_clusters    = toset([for cluster in local.namespace_clusters : cluster if endswith(cluster, "-octo-live")])

  # Single cluster targets used by the dedicated octo provider aliases.
  octo_nonlive_cluster = one(local.octo_nonlive_clusters)
  octo_live_cluster    = one(local.octo_live_clusters)
...
<<<<<<< HEAD
  ...
  namespace_team_access_assignments_octo_nonlive = {
    ...
    key => assignment
    if contains(local.octo_nonlive_clusters, assignment.cluster)
  }

  namespace_team_access_assignments_octo_live = {
    for key, assignment in local.namespace_team_access_assignments :
    key => assignment
    if contains(local.octo_live_clusters, assignment.cluster)
  }
